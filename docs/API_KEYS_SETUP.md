...
### KIS API 토큰 발급 실패 (403 에러)

**에러 메시지:**
```
[KIS-Index] Token request failed: 403
```
...
| 원인 | 해결 방법 |
|------|----------|
| **잘못된 자격 증명** | App Key / App Secret 재확인 |
| **계정 미활성화** | KIS Developers에서 앱 상태 확인 |
| **서버 점검** | KIS Developers 공지사항 확인 |

**참고:** KIS API 없이도 앱은 정상 동작합니다. 지수 비교 차트만 표시되지 않습니다.
