...
export const DEMO_CUMULATIVE_DIVIDEND: CumulativeDividendData = {
  data: DEMO_MONTHLY_DIVIDENDS.reduce((acc: { month: string; cumulative: number }[], d) => {
...
export const DEMO_DIVIDEND_TRANSACTIONS: DemoDividendTransaction[] = [
  ...
  { date: '2024-12-05', ticker: 'AAPL', name: '애플', amountKRW: 34800, amountUSD: 24.0 },
  { date: '2024-11-20', ticker: 'NVDA', name: '엔비디아', amountKRW: 2900, amountUSD: 2.0 },
  { date: '2024-11-15', ticker: 'GOOGL', name: '알파벳', amountKRW: 14500, amountUSD: 10.0 },
  { date: '2024-11-05', ticker: 'AAPL', name: '애플', amountKRW: 34800, amountUSD: 24.0 },
  ...
  { date: '2024-10-10', ticker: 'AAPL', name: '애플', amountKRW: 34800, amountUSD: 24.0 },
  { date: '2024-09-25', ticker: '000660', name: 'SK하이닉스', amountKRW: 25000, amountUSD: 17.24 },
  { date: '2024-09-15', ticker: 'NVDA', name: '엔비디아', amountKRW: 2900, amountUSD: 2.0 },
  { date: '2024-09-05', ticker: 'AAPL', name: '애플', amountKRW: 34800, amountUSD: 24.0 },
  { date: '2024-08-20', ticker: 'GOOGL', name: '알파벳', amountKRW: 14500, amountUSD: 10.0 },
  {
    date: '2024-08-15',
    ticker: 'MSFT',
    name: '마이크로소프트',
  ...
  { date: '2024-08-10', ticker: 'AAPL', name: '애플', amountKRW: 34800, amountUSD: 24.0 },
  { date: '2024-07-25', ticker: '005930', name: '삼성전자', amountKRW: 50000, amountUSD: 34.48 },
  { date: '2024-07-15', ticker: 'NVDA', name: '엔비디아', amountKRW: 2900, amountUSD: 2.0 },
  { date: '2024-07-05', ticker: 'AAPL', name: '애플', amountKRW: 34800, amountUSD: 24.0 },
  {
    date: '2024-06-20',
    ticker: 'MSFT',
    name: '마이크로소프트',
  ...
  { date: '2024-06-15', ticker: 'GOOGL', name: '알파벳', amountKRW: 14500, amountUSD: 10.0 },
]
...
// 총 투자금 계산
const totalInvested = DEMO_PORTFOLIO.reduce((acc, item) => acc + item.avgPrice * item.quantity, 0)
...
// 이번달 배당금
const thisMonthDividend = DEMO_MONTHLY_DIVIDENDS[DEMO_MONTHLY_DIVIDENDS.length - 1]?.amount || 0

// 올해 배당금
const currentYear = new Date().getFullYear()
const yearlyDividend = DEMO_MONTHLY_DIVIDENDS.filter((d) => d.year === currentYear).reduce(
  (acc, d) => acc + d.amount,
  0,
)
...
const DEMO_DIVIDEND_BY_ACCOUNT: { general: DividendAccountData; taxSaving: DividendAccountData } = {
  general: {
    thisMonthDividend: Math.round(
      (DEMO_MONTHLY_DIVIDENDS[DEMO_MONTHLY_DIVIDENDS.length - 1]?.amount || 0) * 0.6,
    ),
  ...
  taxSaving: {
    thisMonthDividend: Math.round(
      (DEMO_MONTHLY_DIVIDENDS[DEMO_MONTHLY_DIVIDENDS.length - 1]?.amount || 0) * 0.4,
    ),
...
const investmentDays = Math.floor((Date.now() - firstDepositDate.getTime()) / (1000 * 60 * 60 * 24))
