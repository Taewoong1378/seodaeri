import { BarChart3, Building2, Cpu, DollarSign, Gift, TrendingUp, Wallet } from 'lucide-react'
import type { ReactElement } from 'react'
import { createElement } from 'react'

// Banner Provider 타입 (none 추가 - 모든 배너 숨김)
export type BannerProvider =
  | 'none'
  | 'all'
  | 'tiger'
  | 'sol'
...
const ALL_CAROUSEL_BANNERS: BannerItem[] = [
  {
    ...
    image: '/images/banners/kodex/banner-kodex-dividend.webp',
    iconName: 'TrendingUp',
    action: '상품 확인하기',
  },
  {
    ...
    image: '/images/banners/kiwoom/banner-kiwoom-event.webp',
    iconName: 'Gift',
    action: '이벤트 확인',
  },
  {
    ...
    image: '/images/banners/all/banner-toss-collection.webp',
    iconName: 'Wallet',
    action: '시작하기',
  },
  {
    ...
    image: '/images/banners/all/banner-mirae-pension.webp',
    iconName: 'Building2',
    action: '자세히 보기',
  },
]
...
const ALL_SMALL_BANNERS: SmallBannerItem[] = [
  {
    ...
    image: '/images/banners/sol/banner-sol-dividend.webp',
    link: '#',
  ...
  },
  {
    ...
    image: '/images/banners/tiger/banner-tiger-tech10.webp',
    link: '#',
...
const ALL_TRANSACTION_BANNERS: TransactionBannerItem[] = [
  ...
  },
  {
    ...
    image: '/images/banners/tiger/banner-tiger-sp500.webp',
...
const TIGER_CAROUSEL_BANNERS: BannerItem[] = [
  ...
  },
  {
    ...
    bgGradient: 'from-orange-600 to-blue-900',
    image: '/images/banners/tiger/banner-tiger-nasdaq100.webp',
    iconName: 'BarChart3',
    action: '상품 확인하기',
  ...
  },
  {
    ...
    bgGradient: 'from-orange-600 to-blue-900',
    image: '/images/banners/tiger/banner-tiger-dividend.webp',
    iconName: 'DollarSign',
    action: '상품 확인하기',
...
const TIGER_SMALL_BANNERS: SmallBannerItem[] = [
  {
    ...
    image: '/images/banners/tiger/banner-tiger-semiconductor.webp',
...
const SOL_CAROUSEL_BANNERS: BannerItem[] = [
  ...
  },
  {
    ...
    bgGradient: 'from-cyan-500 to-blue-900',
    image: '/images/banners/sol/banner-sol-sp500.webp',
    iconName: 'TrendingUp',
    action: '상품 확인하기',
    link: 'https://www.shinhanamc.com/product/etf/domestic/overview.do',
  },
  {
    ...
    bgGradient: 'from-cyan-500 to-blue-900',
    image: '/images/banners/sol/banner-sol-nasdaq100.webp',
    iconName: 'BarChart3',
    action: '상품 확인하기',
    link: 'https://www.shinhanamc.com/product/etf/domestic/overview.do',
  },
  {
    ...
    bgGradient: 'from-cyan-500 to-blue-900',
    image: '/images/banners/sol/banner-sol-gold.webp',
    iconName: 'Wallet',
    action: '상품 확인하기',
    link: 'https://www.shinhanamc.com/product/etf/domestic/overview.do',
  },
...
const KODEX_CAROUSEL_BANNERS: BannerItem[] = [
  {
    ...
    image: '/images/banners/kodex/banner-kodex-sp500.webp',
    iconName: 'TrendingUp',
    action: '상품 확인하기',
  ...
  },
  {
    ...
    bgGradient: 'from-indigo-600 to-purple-900',
    image: '/images/banners/kodex/banner-kodex-nasdaq100.webp',
    iconName: 'BarChart3',
    action: '상품 확인하기',
    link: 'https://www.kodex.com/product_view.do',
  },
  ...
  },
  {
    ...
    bgGradient: 'from-indigo-600 to-purple-900',
    image: '/images/banners/kodex/banner-kodex-semiconductor.webp',
    iconName: 'Cpu',
    action: '상품 확인하기',
    link: 'https://www.kodex.com/product_view.do',
  },
...
const RISE_CAROUSEL_BANNERS: BannerItem[] = [
  {
    ...
    image: '/images/banners/rise/banner-rise-sp500.webp',
    iconName: 'TrendingUp',
    action: '상품 확인하기',
  ...
  },
  {
    ...
    bgGradient: 'from-yellow-500 to-amber-800',
    image: '/images/banners/rise/banner-rise-nasdaq100.webp',
    iconName: 'BarChart3',
    action: '상품 확인하기',
    link: 'https://www.kbam.co.kr/etf/etf-product-list.do',
  },
  {
    ...
    bgGradient: 'from-yellow-500 to-amber-800',
    image: '/images/banners/rise/banner-rise-dividend.webp',
    iconName: 'DollarSign',
    action: '상품 확인하기',
    link: 'https://www.kbam.co.kr/etf/etf-product-list.do',
  },
  {
    ...
    bgGradient: 'from-yellow-500 to-amber-800',
    image: '/images/banners/rise/banner-rise-kospi.webp',
    iconName: 'Building2',
    action: '상품 확인하기',
    link: 'https://www.kbam.co.kr/etf/etf-product-list.do',
  },
...
const KIWOOM_CAROUSEL_BANNERS: BannerItem[] = [
  ...
  },
  {
    ...
    bgGradient: 'from-pink-600 to-rose-900',
    image: '/images/banners/kiwoom/banner-kiwoom-overseas.webp',
    iconName: 'TrendingUp',
    action: '거래하기',
    link: 'https://www.kiwoom.com',
  },
...
const SEODAERI_CAROUSEL_BANNERS: BannerItem[] = [
  {
    id: 1,
    title: '서대리 적립식 플랜',
    description: '월급날마다 자동으로 쌓이는 나만의 포트폴리오',
    subtext: '매월 10만원부터 시작하는 ETF 자동 적립 투자',
    bgGradient: 'from-emerald-600 to-slate-900',
    image: '/images/banners/seodaeri/banner-seodaeri-savings.webp',
    iconName: 'Wallet',
    action: '적립 시작하기',
  ...
  },
  {
    ...
    subtext: '월배당 ETF 조합으로 매달 현금흐름 만들기',
    bgGradient: 'from-emerald-600 to-slate-900',
    image: '/images/banners/seodaeri/banner-seodaeri-dividend.webp',
    iconName: 'DollarSign',
    action: '배당 플랜 보기',
    link: SEODAERI_YOUTUBE_URL,
  },
  {
    id: 3,
    title: '서대리 글로벌 분산투자',
    description: '미국·한국·글로벌 자산을 한 번에',
    subtext: 'S&P500 + 나스닥 + 배당주 최적 배분 전략',
    bgGradient: 'from-emerald-600 to-slate-900',
    image: '/images/banners/seodaeri/banner-seodaeri-global.webp',
    iconName: 'TrendingUp',
    action: '포트폴리오 보기',
    link: SEODAERI_YOUTUBE_URL,
  },
  {
    id: 4,
    title: '서대리 연금저축 가이드',
    description: '세액공제 받으면서 노후 준비까지',
    subtext: '연금저축 ETF 포트폴리오 무료 컨설팅',
    bgGradient: 'from-emerald-600 to-slate-900',
    image: '/images/banners/seodaeri/banner-seodaeri-pension.webp',
    iconName: 'Building2',
    action: '가이드 확인',
    link: SEODAERI_YOUTUBE_URL,
  },
...
const SEODAERI_SMALL_BANNERS: SmallBannerItem[] = [
  {
    id: 1,
    title: '서대리 적립식 플랜',
...
const SEODAERI_TRANSACTION_BANNERS: TransactionBannerItem[] = [
  {
    id: 1,
    title: '서대리 배당 캘린더',
    description: '매달 배당이 들어오는 포트폴리오 설계',
...
export function getBannerProvider(): BannerProvider {
  ...
  if (['tiger', 'sol', 'kodex', 'rise', 'kiwoom', 'seodaeri'].includes(provider)) {
    return provider
  }
  return 'all'
}
...
export function getCarouselBanners(provider?: BannerProvider): BannerItem[] {
  ...
  switch (activeProvider) {
    ...
    case 'seodaeri':
      return SEODAERI_CAROUSEL_BANNERS
    default:
      // 'all' 또는 기타 값은 모든 배너 표시
...
export function getTransactionBanners(provider?: BannerProvider): TransactionBannerItem[] {
  ...
  switch (activeProvider) {
    ...
    case 'seodaeri':
      return SEODAERI_TRANSACTION_BANNERS
    default:
      // 'all' 또는 기타 값은 모든 배너 표시
  ...
  switch (activeProvider) {
    ...
    case 'tiger':
      return {
        ...
        image: '/images/banners/tiger/banner-tiger-benefit.webp',
        link: 'https://investments.miraeasset.com/tigeretf/ko/main/index.do',
        buttonText: 'ETF 둘러보기',
        // TIGER: 오렌지/골드 테마
    ...
    case 'sol':
      return {
        ...
        image: '/images/banners/sol/banner-sol-benefit.webp',
        link: 'https://www.shinhanamc.com/product/etf/domestic/overview.do',
        buttonText: 'ETF 둘러보기',
        // SOL: 시안/블루 테마 (신한)
    ...
    case 'kodex':
      return {
        ...
        image: '/images/banners/kodex/banner-kodex-benefit.webp',
        link: 'https://www.kodex.com/product_view.do',
        buttonText: 'ETF 둘러보기',
        // KODEX: 네이비/퍼플 테마 (삼성)
    ...
    case 'rise':
      return {
        ...
        image: '/images/banners/rise/banner-rise-benefit.webp',
        link: 'https://www.kbam.co.kr/etf/etf-product-list.do',
        buttonText: 'ETF 둘러보기',
        // RISE: 옐로우/골드 테마 (KB)
    ...
    case 'kiwoom':
      return {
        ...
        image: '/images/banners/kiwoom/banner-kiwoom-benefit.webp',
        link: 'https://www.kiwoom.com',
        buttonText: '혜택받기',
        // Kiwoom: 핑크/로즈 테마
    ...
    case 'seodaeri':
      return {
        title: '똑똑한 직장인의 투자 파트너',
        highlight: '서대리증권',
        subtitle: '적립식 투자 · 배당 캘린더 · 글로벌 분산 · 연금저축',
        image: '/images/banners/seodaeri/banner-seodaeri-benefit.webp',
        link: SEODAERI_YOUTUBE_URL,
        buttonText: '서비스 둘러보기',
        // 서대리: 에메랄드/틸 테마
