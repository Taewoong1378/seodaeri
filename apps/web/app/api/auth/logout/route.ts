...
export async function POST() {
  try {
    ...
    response.headers.append('Set-Cookie', `authjs.session-token=; ${cookieOptions}; SameSite=Lax`)
    response.headers.append('Set-Cookie', `authjs.callback-url=; ${cookieOptions}; SameSite=Lax`)
    response.headers.append('Set-Cookie', `authjs.csrf-token=; ${cookieOptions}; SameSite=Lax`)
    response.headers.append(
      'Set-Cookie',
