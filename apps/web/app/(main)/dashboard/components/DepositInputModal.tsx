...
export function DepositInputModal() {
  ...
  const handleSave = () => {
    ...
    saveDeposit(
      ...
      },
      {
        onSuccess: (result) => {
          if (result.success) {
            toast.success(isWithdraw ? '출금내역이 저장되었습니다.' : '입금내역이 저장되었습니다.')
  ...
  const [formattedRecurringAmount, setFormattedRecurringAmount] = useState<string>('')
          ...
          <div className="flex-1 overflow-y-auto p-5">
            ...
            {mode === 'recurring' && (
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="recurringAccount" className="text-sm font-medium text-foreground">
                    계좌
                  </Label>
                  <Select
                ...
                <div className="space-y-2">
                  <Label htmlFor="recurringAmount" className="text-sm font-medium text-foreground">
                    입금 금액
                  </Label>
                  <div className="relative">
                    <Input
                ...
                <div className="space-y-2">
                  <Label htmlFor="recurringMemo" className="text-sm font-medium text-foreground">
                    비고
                  </Label>
                  <Input
                    id="recurringMemo"
