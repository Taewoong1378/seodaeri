        ...
        {chartData.map((item) => (
          ...
          >
            ...
            <div className="space-y-0">
              <div
                className={`text-[10px] font-semibold leading-tight ${item.thisYear >= 0 ? 'text-blue-500' : 'text-muted-foreground'}`}
              >
                {item.thisYear >= 0 ? '+' : ''}
                {item.thisYear.toFixed(1)}%
              </div>
              <div
                className={`text-[8px] leading-tight ${item.annualized >= 0 ? 'text-red-500' : 'text-muted-foreground'}`}
              >
                연{item.annualized >= 0 ? '+' : ''}
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <div
              style={{
                ...
                height: '16px',
                borderRadius: '2px',
                backgroundColor: COLORS.annualized,
              }}
            />
