...
export function GoalSettingModal({ open, onOpenChange, type, currentGoal }: GoalSettingModalProps) {
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-5">
          <div className="space-y-5">
            <p className="text-sm text-muted-foreground text-center">{labels.description}</p>
