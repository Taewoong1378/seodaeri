  ...
  return (
    <>
        ...
        >
          <div className="p-5 pb-3 border-b border-border">
            <DialogHeader className="flex flex-row items-center justify-between">
              <DialogTitle className="text-destructive text-lg font-bold">회원탈퇴</DialogTitle>
              <DialogClose asChild>
                <Button
                  variant="ghost"
                  size="icon"
      ...
      <Dialog
        ...
        onOpenChange={(open) => setErrorAlert((prev) => ({ ...prev, isOpen: open }))}
      >
        <DialogContent
          className="sm:max-w-[360px] flex flex-col p-0 gap-0 overflow-hidden rounded-[20px] bg-popover border-border text-popover-foreground"
          style={{
        ...
        >
          <div className="p-5 pb-3 border-b border-border">
            <DialogHeader className="flex flex-row items-center justify-between">
              <DialogTitle className="text-destructive text-lg font-bold">오류</DialogTitle>
              <DialogClose asChild>
                <Button
                  variant="ghost"
                  size="icon"
          ...
          <div className="p-5 space-y-4">
            <div className="flex flex-col items-center text-center gap-3">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">{errorAlert.message}</p>
            </div>
            <Button
