      ...
      <nav className="sticky top-0 z-50 w-full border-b border-slate-100 bg-white/80 backdrop-blur-md">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-500">
            ...
            <Link href="#philosophy" className="hover:text-slate-900 transition-colors">
              철학
            </Link>
      ...
      <section className="pt-24 pb-32 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-600 mb-12 max-w-2xl mx-auto leading-relaxed font-normal">
            서대리TV의 투자 철학을 담은 앱, <strong>굴림(Gulim)</strong>.
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button
              asChild
              size="lg"
              className="h-14 px-8 text-lg rounded-full bg-slate-900 text-white hover:bg-slate-800 shadow-xl hover:shadow-2xl hover:-translate-y-0.5 transition-all duration-300"
            >
              <Link href="/login">
                무료로 시작하기
            ...
            <Link
              href="https://www.youtube.com/@서대리TV"
              target="_blank"
              className="group flex items-center gap-2 text-slate-500 hover:text-slate-900 transition-colors px-6 py-4"
            >
              <span className="border-b border-transparent group-hover:border-slate-900 transition-all">
                서대리TV 방문하기
              </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="space-y-4">
              ...
              <p className="text-slate-500 leading-relaxed">
                복잡한 설정이나 스프레드시트 연동 없이, 가입 후 바로 투자 기록을 시작하세요.
                한국/미국 주식 실시간 시세까지 즉시 제공됩니다.
              </p>
            </div>
            <div className="space-y-4">
              <div className="w-10 h-10 rounded-full bg-white border border-slate-200 flex items-center justify-center shadow-sm">
              ...
              <p className="text-slate-500 leading-relaxed">
                복잡한 숫자들이 아름다운 차트와 대시보드로 변환됩니다. 주요 지수 대비 수익률까지
                한눈에 파악하세요.
              </p>
            </div>
            <div className="space-y-4">
              ...
              <p className="text-slate-500 leading-relaxed">
                단순한 수익률을 넘어, 월별 배당금 흐름과 연도별 성장 추이를 분석합니다. 현금 흐름을
                만드는 즐거움을 느껴보세요.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg text-slate-500 mb-8 leading-relaxed">
                복잡한 스프레드시트 연동이나 데이터 이관 없이, 계정만 만들면 즉시 투자 기록을 시작할
                수 있습니다. 실시간 주가 조회부터 배당금 관리까지, 모든 기능이 준비되어 있습니다.
              </p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <p className="text-lg text-slate-500 mb-8 leading-relaxed">
                총 자산, 수익률, 그리고 예상 배당금까지. 투자 현황을 직관적인 대시보드로 확인하세요.
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg text-slate-500 mb-8 leading-relaxed">
                배당금 입금 알림을 캡처하면, AI가 자동으로 분석해서 입력합니다. 종목명, 금액,
                날짜까지 한 번에. 여러 건의 배당금도 동시에 인식합니다.
              </p>
              <ul className="space-y-3">
                <li className="flex items-center gap-3 text-slate-700">
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <p className="text-lg text-slate-500 mb-8 leading-relaxed">
                매달 들어오는 배당금, 얼마나 늘어나고 있을까요? 월별 배당금, 연도별 성장률, 그리고
                12개월 이동평균까지. 배당 투자자에게 꼭 필요한 분석 지표를 제공합니다.
              </p>
              <Button
                variant="outline"
                className="rounded-full border-slate-200 hover:bg-slate-50 text-slate-900"
              >
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg text-slate-500 mb-8 leading-relaxed">
                이미 서대리TV의 투자 템플릿을 사용하고 계신가요? 기존 데이터를 그대로 연동해서
                모바일에서도 확인할 수 있습니다. 시트와 앱을 병행해서 사용해도 문제없습니다.
              </p>
              <ul className="space-y-3">
                <li className="flex items-center gap-3 text-slate-700">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              asChild
              size="lg"
              className="h-14 px-10 text-lg rounded-full bg-slate-900 text-white hover:bg-slate-800"
            >
              <Link href="/login">무료로 시작하기</Link>
            </Button>
          </div>
          <p className="mt-8 text-sm text-slate-400">* 영원히 무료. 신용카드 정보 불필요.</p>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-12">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-12">
              ...
              <div>
                ...
                <ul className="space-y-3 text-sm text-slate-500">
                  <li>
                    <Link href="mailto:twkang43@gmail.com" className="hover:text-slate-900">
                      문의하기
                    </Link>
                  </li>
                  <li>
